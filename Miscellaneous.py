...
from Animates import Player, Enemy, NPC
...
class HardCodedStuff:
    def __init__ (self, _player):
        ...
        self.descriptions = [Room("You cannot go in that direction... Please try again.", "You cannot go in that direction... Please try again.", []), Room("This is where you were created... The Mii Creation Screen where you, the saviour of your kind, were born", "NEVER APPEARS", [MiiRecoverii("1R"), MiiBuyy("1B", [ShopItem("Bonjour", Ability("heal", 10), 0, 10)], [self.weapons[0]], [self.armour[0]]), MiiDestroyy("1D", [self.enemies[0]], 1000)]), Room("A little room that houses Master Ozana", "You see a small, grey room in front of you. In the middle of the room stands Master Ozana, but he tells you you must defeat the enemy in front of him to be worthy of his time", [MiiRecoverii("2R")]), Room("This is where you were created... The Mii Creation Screen where you, the saviour of your kind, were born3", "Story3", [MiiRecoverii("3R")])]
