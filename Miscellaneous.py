from Inanimates import Armour, Weapon, Item, Ability
from Places import MiiRecoverii
...
class HardCodedStuff:
    def __init__ (self, _player):
        ...
        self.armour = [Armour(1, "Helmet of Beginner's Luck", 0), Armour(2, "Billy's Helm", 2)]
        self.weapons = [Weapon("Billy's Knife", 10, 0)]
