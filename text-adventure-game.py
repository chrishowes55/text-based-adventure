...
print("The Mii Plaza has been overrun by the Evil MICHAnEL, and it is your job to stop him. Find your way east to Master Ozana, he will tell you where to go next.")
playing = True
while playing:
    s = input(">>>").lower()
